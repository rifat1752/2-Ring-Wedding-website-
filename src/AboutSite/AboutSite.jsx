        ...
        <div className="">
          ...
          <div className="mt-16 md:mt-0">  <About></About></div>
           ...
           <div className="    text-justify">
            <div className=" flex mx-5 bg-slate-50 border border-slate-200 rounded-xl flex-col-reverse justify-center items-center md:flex-row gap-5 min-h-screen ">
                ...
                <p data-aos="zoom-in"  className="md:hidden block 2xl:text-lg xl:text-base lg:text-sm text-xs   font-semibold courgette-regular text-slate-700 2xl:mt-10 mx-5 sm:mx-10 my-5"><i>At <span className="text-[#FF007F]">2</span><span className="text-yellow-500">Ring</span>, we believe that every couple's journey towards matrimony is a unique narrative, deserving of an extraordinary celebration. With a passion for creating magical moments and a commitment to unparalleled service, we stand as your dedicated partner in turning your wedding dreams into a breathtaking reality.</i></p>
                 ...
                 <p className="hidden md:block 2xl:text-lg xl:text-base lg:text-sm text-sm    font-semibold courgette-regular text-slate-600 2xl:mt-10 my-5"><i>At <span className="text-[#FF007F]">2</span><span className="text-yellow-500">Ring</span>, we believe that every couple's journey towards matrimony is a unique narrative, deserving of an extraordinary celebration. With a passion for creating magical moments and a commitment to unparalleled service, we stand as your dedicated partner in turning your wedding dreams into a breathtaking reality.</i></p>
                </div>
            </div>
            {/* story */}
           ...
           <Team></Team>
            ...
            <div  className="bg-slate-50 mx-5  my-10 py-10 border border-slate-200 rounded-xl">
                ...
                <p data-aos="fade-down"   className="2xl:text-lg xl:text-base lg:text-sm text-xs text-center  font-semibold courgette-regular text-slate-700  2xl:mt-10 mx-5 md:mx-10 my-5"><i>"Embark on this exciting journey with us, and let's bring your wedding vision to life. Whether you have a clear picture of your dream day or are looking for inspiration, our team is here to guide you every step of the way. Your love story deserves to be celebrated with elegance, and we are honored to be a part of it."</i></p>
