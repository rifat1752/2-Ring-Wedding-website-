            ...
            <div>
                ...
                <div className="min-h-screen  grid lg:grid-cols-3 justify-items-center">
                     <div  className="flex flex-col w-95">
                        ...
                        <p data-aos="zoom-in"  className="text-center mt-5 text-3xl text-[#FF007F] font-semibold">Voluptate</p>
                     </div>
