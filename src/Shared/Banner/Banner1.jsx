...
const Banner1 = () => {
    ...
    const bannerImage = [
        ...
        { image: "https://i.ibb.co/QK64wKr/pexels-viresh-studio-1444442.jpg" ,
            heading:"Love Bound by Tradition",
     ...
     <div className="w-full  top-0 absolute z-10">
                ...
                {bannerImage.map((banner, index) => (
                    <SwiperSlide key={index} className=' '>
                        ...
                        <img className='h-full  brightness-75 blur-[3px] object-cover' src={banner.image} alt={`Banner ${index + 1}`} />
                       ...
                       <h1 data-aos="fade-right" data-aos-duration="1000" className='  text-white  font-bold text-xl sm:text-4xl lg:text-5xl mt-5'>{banner.heading}</h1>
                       <p data-aos="fade-right" data-aos-duration="1000" className='text-slate-200 text-xs courgette-regular  sm:text-base lg:text-xl   mt-2 ms:mt-10 '><i>"{banner.Description}"</i></p>
                       <Link
                    to="/register"
